export const metadata = {
    "home":{
        ...
        "description": "Google Developer Groups（GDG）は、開発者が他の人とつながり、すべてのGoogleプラットフォームで成功するための最も有益な方法となることを目指しています。世界145カ国以上に1,000以上のGDGコミュニティがあります。Google Developer Groupsは世界最大の開発者コミュニティネットワークです。各GDGは、Google開発者技術への専門知識と情熱を共有するプロフェッショナル開発者のための地域コミュニティハブです。GDGプログラムの焦点は、開発者がGoogleの最新かつ最高の開発者技術にアクセスし、共に学び、成功するプロダクトを共に構築し、技術業界の他の開発者や専門家とつながることを支援することです。"
    },
    "activity":{
        "title": "最近の活動 | Google Developer Groups Taiwan",
    ...
    "chapters":{
        ...
        "description": "台湾の全GDG支部"
    },
    "notFound":{
        "title": "404 - ページが見つかりません",
        "description": "申し訳ありませんが、お探しのページが見つかりません。"
    }
};  
