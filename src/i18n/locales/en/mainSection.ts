export const mainSection = {
    ...
    description: "Google's Google Developers program provides visibility, community, and resources to developers in the technology field.",
    whoWeAre: "Who We Are",
    ...
    recruitmentQuote: "We are looking for friends who are willing to share their expertise on Android, Kotlin, Firebase, Flutter, AI, Gemini, TensorFlow, or Google Cloud related topics. Whether it's your own topic you want to share, or any related topics you want to hear, as long as you have a passion for sharing, don't be afraid if your topic is not professional enough. We need simple, easy, and fun talks.",
